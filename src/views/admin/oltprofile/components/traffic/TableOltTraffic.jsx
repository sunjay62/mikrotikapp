...
import EditTraffic from "./useUpdate";
import {
  Card,
  CardHeader,
  Button,
...
export function TableOltTraffic() {
  ...
  const handleDelete = async (id) => {
    ...
    Swal.fire({
      ...
      text: "Are you sure to delete this Traffic?",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          await toast.promise(
            axiosInstance.delete(`${BASE_URL_OLT}/speedprofile/traffic`, {
              ...config,
              data,
            }),
            {
        ...
        >
          <div className="mb-8 items-center justify-between gap-8">
            ...
            <p color="gray" className="mt-1 font-normal">
              See information about all Traffic
            </p>
          </div>
            ...
            {!roleHidden && (
              <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                <Button
                  ...
                  onClick={handleOpen}
                >
                  <BsPlus strokeWidth={2} className="h-4 w-4" /> Add Traffic
                </Button>
              </div>
            )}
          </div>
...
export default TableOltTraffic;
