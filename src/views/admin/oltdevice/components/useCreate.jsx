    ...
    >
      ...
      >
        <Row gutter={16}>
          ...
          <Col span={12}>
            <p className="mb-1">
              <span className="text-red-500">*</span> Select Site Location
            </p>
            <Form.Item
          ...
          <Col span={12}>
            <p className="mb-1">
              <span className="text-red-500">*</span> Select Merk
            </p>
            <Form.Item
              rules={[{ required: true, message: "Merk is required" }]}
              name="merk"
            >
              <Select
                allowClear
          ...
          <Col span={12}>
            <p className="mb-1">
              <span className="text-red-500">*</span> Select Software
            </p>
            <Form.Item
          ...
          <Col span={12}>
            <p className="mb-1">
              <span className="text-red-500">*</span> Telnet User
            </p>
            <Form.Item
              rules={[{ required: true, message: "Telnet User is required" }]}
              name="telnetuser"
            >
              <Input
                style={commonStyle}
          ...
          <Col span={12}>
            <p className="mb-1">
              <span className="text-red-500">*</span> Telnet Password
            </p>
            <Form.Item
              rules={[
                { required: true, message: "Telnet Password is required" },
              ]}
              name="telnetpass"
            >
              <Input
          ...
          <Col span={12}>
            <p className="mb-1">
              <span className="text-red-500">*</span> Telnet Port
            </p>
            <Form.Item
              rules={[{ required: true, message: "Telnet Port is required" }]}
              name="telnetport"
            >
              <Input
                style={commonStyle}
          ...
          <Col span={12}>
            <p className="mb-1">
              <span className="text-red-500">*</span> IP Host
            </p>
            <Form.Item
              rules={[
                { required: true, message: "IP Host is required" },
                {
                  pattern: ipv4Regex,
          ...
          <Col span={12}>
            <p className="mb-1">
              <span className="text-red-500">*</span> SNMP Port
            </p>
            <Form.Item
              rules={[{ required: true, message: "SNMP Port is required" }]}
              name="snmpport"
            >
              <Input
                style={commonStyle}
          ...
          <Col span={12}>
            <p className="mb-1">
              <span className="text-red-500">*</span> SNMP Read Only
            </p>
            <Form.Item
              rules={[
                { required: true, message: "SNMP Read Only is required" },
              ]}
              name="snmpro"
            >
              <Input
          ...
          <Col span={12}>
            <p className="mb-1">
              <span className="text-red-500">*</span> SNMP Write
            </p>
            <Form.Item
              rules={[{ required: true, message: "SNMP Write is required" }]}
              name="snmpwr"
            >
              <Input
                style={commonStyle}
