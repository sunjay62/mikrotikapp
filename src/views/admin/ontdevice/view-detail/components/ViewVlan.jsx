  ...
  const fetchData = async () => {
    try {
      ...
      const responseData = await axiosInstance.post(
        `${BASE_URL_OLT}/onu/configured/info`,
        formData,
        config
      );
      console.log(responseData);
      setData(responseData.data.list_servicevlan);
      setFilteredUsers(responseData.data.list_servicevlan);
      setLoading(false);
    } catch (error) {
      console.log(error);
      setLoading(false);
